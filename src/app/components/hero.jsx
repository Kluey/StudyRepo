    ...
    const tabs = [
        {
          ...
          value: "summerizer",
          content: (    
            <div className="w-full overflow-auto relative h-full rounded-2xl p-10 text-xl md:text-4xl font-inter text-white bg-gradient-to-br from-blue-400 via-blue-600 to-blue-900">
              <div className="flex items-center">
                <LinkPreview url="https://tailwindcss.com" className="font-extralight bg-gradient-to-l from-orange-300 via-orange-500 to-red-600 bg-clip-text text-transparent">
